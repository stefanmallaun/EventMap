...
/*! @azure/msal-common v14.15.0 2024-10-08 */const Wr={tokenRenewalOffsetSeconds:300,preventCorsPreflight:!1},jr={loggerCallback:()=>{},piiLoggingEnabled:!1,logLevel:e.LogLevel.Info,correlationId:t.EMPTY_STRING},Vr={claimsBasedCachingEnabled:!1},Yr={async sendGetRequestAsync(){throw Ct(ht)},async sendPostRequestAsync(){throw Ct(ht)}},Jr={sku:t.SKU,version:At,cpu:t.EMPTY_STRING,os:t.EMPTY_STRING},Xr={clientSecret:t.EMPTY_STRING,clientAssertion:void 0},Zr={azureCloudInstance:wt.None,tenant:`${t.DEFAULT_COMMON_TENANT}`},en={application:{appName:"",appVersion:""}};function tn(e){return e.authOptions.authority.options.protocolMode===Mr.OIDC}
...
/*! @azure/msal-common v14.15.0 2024-10-08 */const an="home_account_id",sn="UPN",cn="client_id",ln="response_type",dn="token_type",hn="req_cnf",un="return_spa_code",gn="x-client-xtra-sku";
/*! @azure/msal-common v14.15.0 2024-10-08 */
/*! @azure/msal-common v14.15.0 2024-10-08 */
...
/*! @azure/msal-common v14.15.0 2024-10-08 */const eo={sendGetRequestAsync:()=>Promise.reject(Ct(ht)),sendPostRequestAsync:()=>Promise.reject(Ct(ht))};
/*! @azure/msal-common v14.15.0 2024-10-08 */
/*! @azure/msal-common v14.15.0 2024-10-08 */
